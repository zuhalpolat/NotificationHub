...
public class FixedEmailSender extends NotificationPackage implements ISender {

    private IValidator validator;
    LocalDate currentDate = LocalDate.of(2020,8,10);

    public FixedEmailSender(FirmDTO firmDTO) {
        super.setLimit(1000);
        super.setPrice(10.0);
    ...
    public void isLimitExceed(MessageDTO messageDTO)
    {
    ...
    public void isPackageValid(MessageDTO messageDTO)
    {
        ...
        if(diff > 0) {
            messageDTO.getFirm().getBill().put(date.plusMonths(1), getPrice());
            setEndDate(date.plusMonths(1));
        }
    }
